...
function ReservationFormContent({ property, onSuccess }: ReservationFormProps) {
  ...
  const [formDatasetFormData] = useState<ReservationData>({
              ...
              <div className="space-y-4">
                <label className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e: any) => setFormData({ ...formData, kycConsent: e.target.checked })}
                    className="mt-1"
                  />
                ...
                <label className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e: any) => setFormData({ ...formData, termsAccepted: e.target.checked })}
                    className="mt-1"
                  />
                  <span className="text-sm text-gray-700">
                ...
                <label className="flex items-start gap-3">
                  <input
                    ...
                    onChange={(e: any) => setFormData({ ...formData, marketingOptIn: e.target.checked })}
                    className="mt-1"
                  />
                  <span className="text-sm text-gray-700">
