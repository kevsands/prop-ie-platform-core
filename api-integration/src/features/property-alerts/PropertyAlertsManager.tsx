...
export default function PropertyAlertsManager({
  ...
  const pausedAlerts = alerts.filter(alert => alert.status === 'paused');
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="flex space-x-2">
                                {alert.channels.filter(c => c.enabled).map((channel) => (
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setAlertForm({ ...alertForm, type: value as PropertyAlert['type'] })}
                    >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mt-2">
                      {['apartment', 'house', 'townhouse', 'penthouse', 'studio', 'duplex'].map((type) => (
                        <label
                          key={type}
                          className="flex items-center space-x-2 cursor-pointer"
                        >
                  ...
                  <div>
                    ...
                    <div className="space-y-3 mt-2">
                      {alertForm.channels.map((channel, index) => (
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setAlertForm({ ...alertForm, frequency: value as PropertyAlert['frequency'] })}
                    >
                      <SelectTrigger className="mt-1">
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) => setAlertForm({ ...alertForm, priority: value as PropertyAlert['priority'] })}
                      className="mt-2"
                    >
                      <div className="flex items-center space-x-2">
