...
import UrgencyMessaging from '@/components/sales/UrgencyMessaging';
import HTBCalculator from '@/components/sales/HTBCalculator';
import ViewingBookingSystem from '@/components/sales/ViewingBookingSystem';
import { realTimeInventoryService } from '@/lib/services/real-time-inventory';
      ...
      <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            {/* Fitzgerald Gardens Urgency Messaging */}
