// Test script for safeCache implementations using ES modules
import { safeCache, ttlCache, asyncSafeCache } from './src/lib/utils/safeCache.js';
...
// Test ttlCache
const ttlCachedAdd = ttlCache(add, 1000); // 1 second TTL
console.log('\nTesting ttlCache:');
...
// Test asyncSafeCache
const asyncCachedAdd = asyncSafeCache(asyncAdd);
