...
export interface Property {
  ...
  isNew?: boolean;
  isReduced?: boolean;
  developmentId: string; // Link to parent development - consistent reference
...
export interface PropertyDetail extends Property {
  ...
  isFeatured?: boolean;
  // The development object is now a fully populated object based on the developmentId
  developmentDetails?: Development | {
    id: string;
    name: string;
    description?: string;
  };
 ...
 * @deprecated Use PropertyDetail instead with its developmentDetails field
 */
