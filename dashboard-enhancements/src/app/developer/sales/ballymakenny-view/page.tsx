...
export default function BallymakennySalesPage() {
  ...
  // Enterprise data integration for Ballymakenny View project
  const {
    project,
    units,
    totalUnits,
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Ballymakenny View sales data...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Ballymakenny View - Sales Management
            <span className="px-3 py-1 bg-yellow-100 text-yellow-800 text-sm font-medium rounded-full">
              19/20 SOLD
            </span>
          </h1>
          <p className="text-gray-600 mt-1">
            NEAR COMPLETION: 20 units - 19 sold, 1 reserved for internal use. Showcase of market success.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-900">Live Unit Data - Ballymakenny View</span>
              ...
              {filteredUnits.map((unit) => (
                <div 
                  ...
                  className={`bg-white rounded-lg border shadow-sm p-4 cursor-pointer transition-all hover:shadow-md ${
                    selectedUnit === unit.id ? 'ring-2 ring-indigo-500 border-indigo-500' : ''
                  }`}
                  ...
                  {filteredUnits.map((unit) => (
                    <tr 
                      ...
                      className={`hover:bg-gray-50 cursor-pointer ${
                        selectedUnit === unit.id ? 'bg-indigo-50' : ''
                      }`}
                      onClick={() => setSelectedUnit(unit.id)}
                    >
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          {selectedUnitData ? (
            ...
            <div className="p-6 text-center text-gray-500">
              ...
              <p className="text-sm mt-1">Ballymakenny View Development</p>
            </div>
          )}
        </div>
      </div>
