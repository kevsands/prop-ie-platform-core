...
describe('Performance Regression Tests', () => {
  ...
  const newMeasurements: Record<keyof typeof DEFAULT_BASELINES, number> = {
    'HomePage-render': 0,
    'PropertyListing-render': 0,
    'PropertyDetail-render': 0,
    'BuyerDashboard-render': 0,
    'CustomizationPage-render': 0,
    'LoginForm-render': 0,
    'RegisterForm-render': 0,
    'PropertySearch-journey': 0,
    'Auth-journey': 0,
    'Customization-journey': 0
  };

  beforeAll(() => {
    // Use the imported singleton performance monitor instance
  ...
  describe('User Journey Performance', () => {
    ...
    it('should complete customization journey within performance thresholds', async () => {
      ...
      const { getByText, getAllByRole } = renderWithProviders(
        <CustomizationPageContent propertyId="property-1" />
      );
