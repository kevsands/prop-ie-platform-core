...
const registerSchema = z.object({
  ...
  agreeToMarketing: z.boolean().optional()}).refine((data) => data.password === data.confirmPassword, {
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => form.setValue('agreeToMarketing', checked as boolean)}
                  disabled={isLoading}
                  className="mt-1"
                />
