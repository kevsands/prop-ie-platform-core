              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="space-y-3">
                      {timelineSteps[activeStep].tasks.map((taskindex) => (
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      {timelineSteps[activeStep].tips.map((tipindex) => (
                        <li key={index} className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="space-y-3">
                      {timelineSteps[activeStep].documents.map((docindex) => (
                        <li key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {timelineSteps[activeStep].costs.map((costindex) => (
            ...
            {digitalFeatures.map((featureindex) => (
              <div key={index} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all">
                ...
                <ul className="space-y-2">
                  {feature.benefits.map((benefitbIndex) => (
