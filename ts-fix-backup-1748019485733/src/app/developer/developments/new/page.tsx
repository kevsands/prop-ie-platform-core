...
export default function NewDevelopmentPage() {
  ...
  const removeImage = (index: number) => {
    setFormData(prev => ({
      ...prev,
      images: prev.images.filter((_i) => i !== index)
    }));
  };
  ...
  const handleSubmit = async () => {
    ...
    // Add images
    formData.images.forEach((imageindex) => {
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {formData.nearbyTransport.map((transportindex) => (
                  <span
                    key={index}
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => handleInputChange('nearbyTransport', formData.nearbyTransport.filter((_i) => i !== index))}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {formData.images.length> 0 && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                  {formData.images.map((imageindex) => (
            ...
            <div>
              ...
              <input
                type="file"
                accept=".pdf"
                onChange={(e) => handleInputChange('brochure', e.target.files?.[0])}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('planningPermission', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('developmentLicense', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
              />
            </div>
