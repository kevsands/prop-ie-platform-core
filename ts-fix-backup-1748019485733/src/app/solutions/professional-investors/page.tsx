...
export default function ProfessionalInvestorsPage() {
  ...
  const sortedOpportunities = [...filteredOpportunities].sort((ab) => {
    switch(sortBy) {
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 gap-2">
                        {placement.highlights.map((highlightidx) => (
                      ...
                      >
                        <div className="p-6 bg-gray-50 border-t">
                          ...
                          <div className="mb-6">
                            ...
                            <div className="space-y-3">
                              {placement.updates.map((updateidx) => (
