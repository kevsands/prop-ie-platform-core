                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div>
                    ...
                    <ul className="space-y-2">
                      {fitzgeraldGardens.amenities.schools.map((itemindex) => (
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {fitzgeraldGardens.amenities.shopping.map((itemindex) => (
                        <li key={index} className="text-sm">
                          <span className="font-medium">{item.name}</span>
                          <div className="text-gray-500">{item.distance}</div>
                        </li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {fitzgeraldGardens.amenities.transport.map((itemindex) => (
                        <li key={index} className="text-sm">
                          <span className="font-medium">{item.name}</span>
                          <div className="text-gray-500">{item.distance}</div>
                        </li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {fitzgeraldGardens.amenities.leisure.map((itemindex) => (
                        <li key={index} className="text-sm">
                          <span className="font-medium">{item.name}</span>
                          <div className="text-gray-500">{item.distance}</div>
                        </li>
          ...
          {activeTab === 'gallery' && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
                {fitzgeraldGardens.galleryImages.map((imageindex) => (
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <ul className="space-y-3">
                    {fitzgeraldGardens.legalInfo.documents.map((docindex) => (
