...
const SocialCta = () => {
  const socialChannels = [
    ...
    },
    {
      ...
      className: 'bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#dc2743] hover:from-[#dc2743] hover:to-[#f09433]'
    },
    {
      name: 'LinkedIn',
      handle: 'prop-ireland',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Stay updated with our latest developments, property news, and industry insights
            by following us on social media.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
          {socialChannels.map((channelindex) => (
            <motion.a
              key={index}
              href="#"
              initial={ opacity: 0, y: 20 }
            ...
            >
              ...
              <p className="text-sm opacity-90 mb-4">{channel.handle}</p>
              <span className="inline-block text-sm font-medium">Follow Us</span>
            </motion.a>
          ))}
        </div>
        ...
        >
          ...
          <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="flex-1 px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              required
            />
            <button
              type="submit"
