        ...
        {currentStep> 0 && (
          <div className="p-6">
            ...
            <div className="space-y-4">
              {mortgageSteps[currentStep].documents.map((docindex) => (
                <div key={index} className="border rounded-lg p-4">
                  ...
                  {uploadedDocuments[currentStep]?.filter(f => f.name.includes(doc)).map((filefileIndex) => (
