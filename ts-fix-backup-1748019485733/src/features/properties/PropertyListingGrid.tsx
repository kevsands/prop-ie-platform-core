        ...
        >
          ...
          <CardContent className="p-4">
            ...
            <div className="flex flex-wrap gap-1 mb-3">
              {property.features.slice(03).map((featureindex) => (
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Slider
                      ...
                      onValueChange={(value) => setFilters(prev => ({ ...prev, priceRange: value as [numbernumber] }))}
                    />
                  ...
                  <div className="space-y-3">
                    ...
                    <Slider
                      ...
                      onValueChange={(value) => setFilters(prev => ({ ...prev, sizeRange: value as [numbernumber] }))}
                    />
                    <div className="flex justify-between text-sm text-gray-600">
