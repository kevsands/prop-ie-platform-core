...
export default function RegulatoryReportingSystem({ organizationId }: RegulatoryReportingSystemProps) {
  ...
  const upcomingDeadlines = filings
    ...
    .sort((ab) => a.filingDeadline.getTime() - b.filingDeadline.getTime())
    .slice(05);
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="text-sm">
                            ...
                            <ul className="list-disc list-inside mt-1">
                              {filing.requirements.map((reqindex) => (
                                <li key={index}>{req}</li>
                              ))}
                            </ul>
                          </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Alert variant="destructive">
                          ...
                          <AlertDescription>
                            <ul className="list-disc list-inside mt-2">
                              {selectedReport.validationStatus.errors.map((errorindex) => (
                      ...
                      {selectedReport.validationStatus.warnings.length> 0 && (
                        <Alert>
                          ...
                          <AlertDescription>
                            <ul className="list-disc list-inside mt-2">
                              {selectedReport.validationStatus.warnings.map((warningindex) => (
