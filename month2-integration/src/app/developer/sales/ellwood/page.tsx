...
export default function EllwoodSalesPage() {
  ...
  // Enterprise data integration for Ellwood project
  const {
    project,
    units,
    totalUnits,
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Ellwood sales data...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Ellwood - Sales Management
            <span className="px-3 py-1 bg-red-100 text-red-800 text-sm font-medium rounded-full">
              SOLD OUT
            </span>
          </h1>
          <p className="text-gray-600 mt-1">
            COMPLETED PROJECT: 46 units - All sold. Showcase development for marketing and portfolio display.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-lg border border-emerald-200 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-gray-900">Live Unit Data - Ellwood</span>
              ...
              {filteredUnits.map((unit) => (
                <div 
                  ...
                  className={`bg-white rounded-lg border shadow-sm p-4 cursor-pointer transition-all hover:shadow-md ${
                    selectedUnit === unit.id ? 'ring-2 ring-emerald-500 border-emerald-500' : ''
                  }`}
                ...
                >
                  ...
                  <div className="mt-3 flex gap-2">
                    <button 
                      ...
                      className="flex-1 px-3 py-1 text-xs bg-emerald-600 text-white rounded hover:bg-emerald-700"
                    >
                  ...
                  {filteredUnits.map((unit) => (
                    <tr 
                      ...
                      className={`hover:bg-gray-50 cursor-pointer ${
                        selectedUnit === unit.id ? 'bg-emerald-50' : ''
                      }`}
                      onClick={() => setSelectedUnit(unit.id)}
                    >
        ...
        <div className="bg-white rounded-lg border shadow-sm">
          {selectedUnitData ? (
            ...
            <div className="p-6 text-center text-gray-500">
              ...
              <p className="text-sm mt-1">Ellwood Development</p>
            </div>
          )}
        </div>
      </div>
    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
          ...
          <button className="mt-2 px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700">
            Select Images
          </button>
        </div>
      </div>
