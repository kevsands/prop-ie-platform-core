    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-blue-100 mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/first-time-buyers/register"
              className="px-6 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-xl font-bold text-base sm:text-lg shadow-lg hover:scale-105 transition-transform duration-200 focus:outline-none focus:ring-4 focus:ring-blue-300 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="px-6 sm:px-10 py-4 sm:py-5 bg-white/80 text-blue-900 rounded-xl font-bold text-base sm:text-lg shadow-lg hover:bg-white focus:outline-none focus:ring-4 focus:ring-blue-300 flex items-center justify-center gap-2"
            >
      ...
      <div className="sticky top-0 z-30 w-full bg-white/70 backdrop-blur-md shadow-md border-b border-blue-100">
        <div className="max-w-5xl mx-auto overflow-x-auto">
          <div className="flex gap-1 sm:gap-2 py-3 sm:py-4 px-2 sm:justify-center min-w-fit">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-2 rounded-full font-medium text-sm sm:text-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-300 whitespace-nowrap
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="bg-yellow-50 p-6 rounded-lg max-w-2xl mx-auto">
                  <p className="text-yellow-800 text-center">
                    You haven't started your HTB application yet. Visit the HTB Calculator tab to begin.
                  </p>
