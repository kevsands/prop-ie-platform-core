...
export class AgentDeveloperCommunicationService {
  ...
  public async sendMessage(
    ...
    try {
      ...
      console.log(`📨 Message sent from ${senderType} ${senderId} to ${recipientType} ${recipientId}`);
      return message;
  ...
  public async createConversation(
    ...
    try {
      ...
      console.log(`💬 Conversation created: ${conversationId} between ${initiatorType} and ${recipientType}`);
      return conversation;
  ...
  public async scheduleMeeting(
    ...
    try {
      ...
      console.log(`📅 Meeting scheduled: ${meetingId} - ${meeting.title}`);
      return meeting;
  ...
  private initializeSampleData(): void {
    ...
    console.log('✅ Agent-Developer Communication Service initialized');
  }
