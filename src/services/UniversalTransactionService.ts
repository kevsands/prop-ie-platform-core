...
export class UniversalTransactionService {
  ...
  private async initializeProjectRegistry(): Promise<void> {
    try {
      ...
      console.log(`✅ Universal Transaction Service initialized with ${this.projectRegistry.size} projects`);
    } catch (error) {
      console.error('Error initializing project registry:', error);
    }
  }
  ...
  public async createUniversalCase(
    ...
    try {
      ...
      console.log(`✅ Universal case created: ${solicitorCase.caseNumber} for ${project.name}`);
      return solicitorCase;

    } catch (error) {
      console.error('Error creating universal case:', error);
      return null;
    }
  }
  ...
  public async getUniversalTransactionData(): Promise<UniversalTransactionData> {
    try {
      ...
      console.error('Error getting universal transaction data:', error);
      throw error;
    }
  }
