...
export class ProjectDataService {
  ...
  public async updateUnitBuyer(
    ...
    try {
      ...
      console.log(`✅ Unit ${unitId} buyer information updated successfully`);
      return true;
    } catch (error) {
      console.error('Error updating unit buyer:', error);
      return false;
    }
  }
  ...
  public broadcastStateUpdate(update: ProjectStateUpdate): void {
    try {
      ...
      console.log(`📡 State update broadcast for project ${update.projectId}:`, update.eventType);
    } catch (error) {
