            ...
            <>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-900">AI Pricing Recommendations</h4>
                    <p className="text-blue-700 text-sm">
                      Based on real-time market analysis, competitor pricing, and demand patterns
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-sm">
                    Market conditions favor a 2-3% price increase on select units. 
                    Current demand exceeds supply in the 1-2 bedroom segment.
                  </p>
                </div>
              </div>
            </div>
