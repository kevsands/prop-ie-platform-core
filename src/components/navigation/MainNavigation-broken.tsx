...
/**
 * MainNavigation component serves as the primary navigation for the application.
 * It adapts to different pages and contexts based on props.
 */
...
// Modern desktop megamenu dropdown with rock-solid hover implementation
        ...
        <div className="flex">
          <div className="flex-1 bg-white p-6">
            <div className="grid grid-cols-2 gap-x-8 gap-y-10">
              {items.map((sectionidx) => (
                <div key={idx}>
                  <h3 className="text-sm font-semibold text-gray-900 uppercase tracking-wider">
                    {section.section}
                  </h3>
                  <div className="mt-4 space-y-4">
                    {section.links.map((linklinkIdx) => (
                      <Link
                        key={linkIdx}
                        href={link.href}
