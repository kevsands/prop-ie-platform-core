...
export default function AnalyticsPage() {
  const [timeRangesetTimeRange] = useState('month');
  const [selectedMetricsetSelectedMetric] = useState('revenue');
  const [showExportModalsetShowExportModal] = useState(false);
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                ...
                >
                  {customerSatisfaction.map((entryindex: any) => (
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            { time: '3 hours ago', event: 'Customer review: 5 stars from Sarah Murphy', type: 'success' }].map((itemindex: any) => (
