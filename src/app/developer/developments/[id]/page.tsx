...
export default function DevelopmentDetailPage() {
  ...
  const [selectedUnitTypesetSelectedUnitType] = useState<string | null>(null);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            {['overview', 'units', 'viewings', 'documents', 'analytics'].map((tab: any) => (
              <button
                key={tab}
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {development.UnitType.map((type: any) => (
              ...
              <div>
                ...
                <div className="bg-white rounded-lg shadow">
                  <table className="min-w-full">
                    ...
                    <tbody>
                      {selectedType.schedule.map((item: any) => (
        ...
        {activeTab === 'units' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {selectedType?.units.map((unit: any) => (
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow">
              <table className="min-w-full">
                ...
                <tbody>
                  {development.Viewing.map((viewing: any) => (
