...
export default function EnterpriseInvoicesPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading enterprise invoices...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !project) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <p className="text-gray-600">Error loading enterprise invoices</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Enterprise Invoice Manager</h2>
          <p className="text-gray-600 mt-1">Advanced invoice management and automation for {project.name}</p>
        </div>
