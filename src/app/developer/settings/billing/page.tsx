...
export default function BillingSettingsPage() {
  ...
  const [billingPeriodsetBillingPeriod] = useState('monthly');
  const [showAddPaymentMethodsetShowAddPaymentMethod] = useState(false);
  ...
  const getUsagePercentage = (currentlimit) => {
    if (limit === 'Unlimited') return 0;
    return Math.min((current / limit) * 100100);
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            {Object.entries(usage).map(([keydata]) => {
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                {usageHistory.slice(-6).map((monthindex) => (
