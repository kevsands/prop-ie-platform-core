...
export default function DeveloperLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    // Financial Management
    {
      ...
      isDropdown: true,
      subItems: [
        { name: 'Financial Dashboard', href: '/developer/finance/dashboard', icon: DollarSign },
        { name: 'Tax Compliance', href: '/developer/finance/tax-compliance', icon: Shield },
        { name: 'Professional Invoices', href: '/developer/invoices/professional', icon: FileText },
        { name: 'Quantity Surveyor', href: '/developer/quantity-surveyor', icon: Calculator },
    ...
    // Team Management
    {
      ...
      subItems: [
        ...
        { name: 'Quantity Surveyors', href: '/developer/team/quantity-surveyors', icon: Calculator },
        { name: 'Architects', href: '/developer/team/architects', icon: Building2 },
        { name: 'Engineers', href: '/developer/team/engineers', icon: Wrench },
        { name: 'All Professionals', href: '/developer/team/professionals', icon: Award },
