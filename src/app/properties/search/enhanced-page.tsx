...
const matchPropertiesWithAI = (properties: Property[], query: string): Property[] => {
  ...
  return properties
    ...
    .sort((ab: any) => b.score - a.score) // Sort by relevance score
            ...
            <div className="mt-4">
              <div className="relative">
                ...
                <Input
                  ...
                  onKeyDown={(e: any) => e.key === 'Enter' && handleAISearch()}
                />
                <Button 
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      ...
                      <Slider
                        ...
                        onValueChange={(values: any) => setFilters({
                          ...filters,
                          priceMin: values[0],
                          priceMax: values[1]
                        })}
                  ...
                  <div>
                    ...
                    <Select value={filters.bedrooms} onValueChange={(value: any) => 
                  ...
                  <div>
                    ...
                    <Select value={filters.propertyType} onValueChange={(value: any) => 
              ...
              <>
                ...
                {aiMatchedProperties.length> 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {aiMatchedProperties.map((property: any) => (
                      <PropertyCard 
                        key={property.id} 
                        property={property} 
