...
export async function GET(request: NextRequest) {
  try {
    ...
    const displayMonths = projectionPeriod === '12months' ? months : months.slice(0);

    const revenueProjection = {
      baseline: [350000, 370000, 390000, 410000, 430000, 450000, 470000, 490000510000530000550000570000],
      optimistic: [380000, 400000, 430000, 460000, 490000, 520000, 550000, 580000610000640000670000700000],
      pessimistic: [320000, 330000, 340000, 350000, 360000, 370000, 380000, 390000400000410000420000430000]
    };

    const profitProjection = {
      baseline: [105000, 110000, 115000, 120000, 125000, 130000, 135000, 140000145000150000155000160000],
      optimistic: [120000, 130000, 140000, 150000, 160000, 170000, 180000, 190000200000210000220000230000],
      pessimistic: [90000, 95000, 100000, 105000, 110000, 115000, 120000, 125000130000135000140000145000]
    };

    const cashFlowProjection = {
      inflows: [350000, 370000, 390000, 410000, 430000, 450000, 470000, 490000510000530000550000570000],
      outflows: [240000, 250000, 260000, 270000, 280000, 290000, 300000, 310000320000330000340000350000],
      net: [110000, 120000, 130000, 140000, 150000, 160000, 170000, 180000190000200000210000220000],
      cumulativeCash: [600000, 720000, 850000, 990000, 1140000, 1300000, 1470000, 16500001840000204000022500002470000]
    };
