...
export default function BuyerJourneyPage() {
  const [activePhasesetActivePhase] = useState('financing');
  const [showDetailssetShowDetails] = useState(false);
  const [selectedTasksetSelectedTask] = useState(null);
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {currentPhase.documents.map((docindex) => (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {currentPhase.milestones.map((milestoneindex) => (
