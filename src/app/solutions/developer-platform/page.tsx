      ...
      <section className="py-20 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Dive deeper into our specialized developer solutions
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <Link 
              href="/solutions/developers/marketing"
              className="group bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-4">
                  <MessageSquare className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-900">AI-Powered Marketing</h3>
                <ArrowUpRight className="ml-auto h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
              </div>
              <p className="text-gray-600 mb-4">
                Revolutionize your property marketing with AI agents and automation. 
                Reduce costs by 65% while increasing lead conversion by 45%.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">AI Agents</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm">Automation</span>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Advanced Sales Platform</h3>
                <ArrowUpRight className="ml-auto h-5 w-5 text-gray-400 group-hover:text-blue-600 transition-colors" />
              </div>
              <p className="text-gray-600 mb-4">
                Complete sales management with CRM, digital contracts, and real-time analytics. 
                Sell 3x faster with our modern developer platform.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">CRM</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Digital Contracts</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">ROI Calculator</span>
              </div>
            </Link>
          </div>
        </div>
